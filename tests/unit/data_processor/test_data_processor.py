...
from delm.strategies.splitting_strategies import (
    ParagraphSplit,
    FixedWindowSplit,
    RegexSplit,
)
...
class TestDataProcessor:
    ...
    def test_initialization(self):
        ...
        config = DataPreprocessingConfig(
            target_column=SYSTEM_RAW_DATA_COLUMN, drop_target_column=False
        )
    ...
    def test_initialization_with_splitting(self):
        ...
        config = DataPreprocessingConfig(
            target_column=SYSTEM_RAW_DATA_COLUMN,
    ...
    def test_initialization_with_scoring(self):
        ...
        config = DataPreprocessingConfig(
            target_column=SYSTEM_RAW_DATA_COLUMN,
            drop_target_column=False,
            relevance_scorer=KeywordScorer(["test", "keyword"]),
        )
        processor = DataProcessor(config)
    ...
    def test_initialization_with_custom_target_column(self):
        ...
        config = DataPreprocessingConfig(
            target_column="custom_column", drop_target_column=False
        )
        processor = DataProcessor(config)
    ...
    def test_load_data_from_dataframe(self):
        ...
        config = DataPreprocessingConfig(target_column="text", drop_target_column=False)
        processor = DataProcessor(config)

        df = pd.DataFrame({"text": ["Hello world", "Test data"], "other": [1, 2]})
    ...
    def test_load_data_from_dataframe_missing_target_column(self):
        ...
        config = DataPreprocessingConfig(
            target_column="missing_column", drop_target_column=False
        )
        processor = DataProcessor(config)
    ...
    def test_load_data_csv_requires_target_column_missing(self, tmp_path):
        ...
        config = DataPreprocessingConfig(target_column="", drop_target_column=False)
        processor = DataProcessor(config)
        ...
        with patch("delm.core.data_processor.loader_factory") as mock_factory:
            ...
            with pytest.raises(
                ValueError, match="Target column is required for .csv files"
            ):
    ...
    def test_load_data_target_column_not_found(self, tmp_path):
        ...
        with patch("delm.core.data_processor.loader_factory") as mock_factory:
            ...
            with pytest.raises(
                ValueError, match="Target column 'missing_column' not found"
            ):
                processor.load_data(csv_file)
    ...
    def test_load_data_target_column_system_raw_data_not_allowed(self, tmp_path):
        ...
        with patch("delm.core.data_processor.loader_factory") as mock_factory:
            ...
            with pytest.raises(
                ValueError,
                match=f"Target column '{SYSTEM_RAW_DATA_COLUMN}' not found",
            ):
                processor.load_data(csv_file)
    ...
    def test_process_dataframe_no_splitting_no_scoring(self):
        ...
        df = pd.DataFrame(
            {SYSTEM_RAW_DATA_COLUMN: ["Hello world", "Test data"], "other": [1, 2]}
        )
    ...
    def test_process_dataframe_with_scoring(self):
        ...
        scorer = KeywordScorer(["test", "data"])
        config = DataPreprocessingConfig(
            target_column=SYSTEM_RAW_DATA_COLUMN,
            drop_target_column=False,
        ...
        assert (
            scores[1] > scores[0]
        )  # "Test data" should have higher score than "Hello world"
    ...
    def test_process_dataframe_with_pandas_score_filter(self):
        ...
        config = DataPreprocessingConfig(
            ...
            drop_target_column=False,
            relevance_scorer=scorer,
            score_filter=f"{SYSTEM_SCORE_COLUMN} > 0.5",  # Use the constant
        )
        processor = DataProcessor(config)
    ...
    def test_process_dataframe_with_fixed_window_split(self):
        ...
        strategy = FixedWindowSplit(window=2, stride=1)
        config = DataPreprocessingConfig(
            target_column=SYSTEM_RAW_DATA_COLUMN,
            drop_target_column=False,
            splitting_strategy=strategy,
    ...
    def test_process_dataframe_single_record(self):
        ...
        df = pd.DataFrame({SYSTEM_RAW_DATA_COLUMN: ["Single record"], "other": [1]})
