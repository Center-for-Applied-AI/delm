...
class TestDiskExperimentManager:
    ...
    def test_initialization(self, tmp_path):
        ...
        experiment_path = tmp_path / "test_experiment"
        ...
        assert manager.experiment_dir == experiment_path
    ...
    def test_save_and_load_preprocessed_data(self, tmp_path):
        """Test save_preprocessed_data and load_preprocessed_data methods."""
        experiment_path = tmp_path / "experiments" / "test_experiment"
...
"""
        ...
        try:
            ...
            config = DELMConfig(schema=schema, provider="openai", model="gpt-4o-mini")
