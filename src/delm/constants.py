...
DEFAULT_PANDAS_SCORE_FILTER = (
    None  # Pandas query string for filtering by score (None = no filter)
)
...
DEFAULT_AUTO_CHECKPOINT_AND_RESUME = (
    True  # Whether to automatically checkpoint and resume
)
...
DEFAULT_SEMANTIC_CACHE_BACKEND = (
    "sqlite"  # Cache backend: "sqlite" | "lmdb" | "filesystem"
)
